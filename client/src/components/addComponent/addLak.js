...
const AddLak = () => {
  ...
  return (
    <div className="container-fluid">
      <h1 className="display-3 title">DODAJ LAK ZA NOKTE</h1>
          ...
          <form className="forma was-validated">
            <div className="form-group">
              ...
              <input
                ...
                id="inputNaziv"
                placeholder="Unesite naziv laka"
                value={naziv}
